...
let F_data = document.getElementById('F_data');
...
let pg = document.getElementById('pg_data');
let B = document.getElementById('B_data');
let J = document.getElementById('J_data');
let T = document.getElementById('T_data');
...
function veiw_data(i){
    ...
    C.innerText = datasale[i].select5;
    pg.innerHTML = datasale[i].select6;
    B.innerHTML = datasale[i].select7;
    J.innerHTML = datasale[i].J_data;
    T.innerHTML = datasale[i].F_data;
